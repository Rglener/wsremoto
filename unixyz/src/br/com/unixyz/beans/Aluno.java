package br.com.unixyz.beans;
 ...
 /*
  * Design Pattern => Coleção de boas práticas(padrões) para OO
  ...
  * 3º) TODA classe modelo, deve possuir no mínimo UM construtor vazio mais um construtor para todos os atributos(cheio)
